...
export function Wallet(): JSX.Element {
  return (
    <>
      <Button className="w-80 px-6 grid grid-cols-[4rem_1fr] gap-x-4 grid-rows-[auto_auto] text-left">
        <MetaMaskLogo className="row-start-1 col-start-1 row-span-2 justify-self-center self-center" />
        <div className="text-sm italic col-start-2 row-start-1 self-end -mb-[0.35rem]">
          Connect
        </div>
        <div className="text-2xl italic col-start-2 row-start-2">MetaMask</div>
      </Button>
      <Button className="w-80 px-6 grid grid-cols-[4rem_1fr] gap-x-4 grid-rows-[auto_auto] text-left">
        <CoinbaseLogo className="row-start-1 col-start-1 row-span-2 justify-self-center self-center" />
        <div className="text-sm italic col-start-2 row-start-1 self-end -mb-[0.35rem]">
          Connect
        </div>
        <div className="text-2xl italic col-start-2 row-start-2">
          Coinbase Wallet
        </div>
      </Button>
      <Button className="w-80 px-6 grid grid-cols-[4rem_1fr] gap-x-4 grid-rows-[auto_auto] text-left">
        <WalletConnectLogo className="row-start-1 col-start-1 row-span-2 justify-self-center self-center" />
        <div className="text-sm italic col-start-2 row-start-1 self-end -mb-[0.35rem]">
          Connect any other wallet
        </div>
        <div className="text-2xl italic col-start-2 row-start-2">
          WalletConnect
        </div>
