...
describe("parseQuery()", () => {
  ...
  const cases: [string, ParsedQuery][] = [
    ...
    // Usernames
    ["h4l", { type: "username", username: 'h4l' }],
    [" H4l ", { type: "username", username: 'h4l' }],
    ["H😧l", { type: "invalid-query", reason: 'username' }],
    ["aaaaaBBBBBcccccDDDDD", { type: "username", username: 'aaaaabbbbbcccccddddd' }],
    ["aaaaaBBBBBcccccDDDDDe", { type: "invalid-query", reason: 'username-length' }],
    // Usernames can look like addresses
    ["0xf00", { type: "username", username: '0xf00' }],
    ["0xaaaBBBBBcccccDDDDD", { type: "username", username: '0xaaabbbbbcccccddddd' }],
    ...
    ["0x2bba0433d7d798981d08ec4ac93d3bd301f3b4bd", { type: "address", address: '0x2bBA0433D7D798981d08EC4aC93d3bd301F3b4Bd' }],
    ["  0x2bba0433d7d798981d08ec4ac93d3bd301f3b4bd  ", { type: "address", address: '0x2bBA0433D7D798981d08EC4aC93d3bd301F3b4Bd' }],
    ["0x2bBA0433D7D798981d08EC4aC93d3bd301F3b4Bd", { type: "address", address: '0x2bBA0433D7D798981d08EC4aC93d3bd301F3b4Bd' }],
    ...
    ["ens.ens", { type: "ensName", ensName: 'ens.ens' }],
    [" ens.ens ", { type: "ensName", ensName: 'ens.ens' }],
